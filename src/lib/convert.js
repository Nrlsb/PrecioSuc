...
// Configura las rutas relativas al directorio raíz del proyecto
const EXCEL_FILE_PATH = path.join(process.cwd(), 'public', 'ListaDeProductos.xlsx');
const JSON_OUTPUT_PATH = path.join(process.cwd(), 'public', 'products.json');
...
export async function convertExcelToJson() {
  try {
    ...
    const productMonedaMap = new Map();
